...
<div class="uploadSection"> 
  ...
  <div class="row">
    ...
    <div class="column">
      <form action="logout.php" method="get">
        <button id="logoutButton" class="styledButton2" type="submit">Logout</button>
      </form>
    </div>
  </div>
  <div class="filterPicker">
    ...
    <input class="upload" type="file"  accept="image/*" name="image" id="file" onchange="loadImage(event)">
    <label  class="styledButton" for="file">Upload Image</label>
  ...
  <div class="original view">
    <div class="content">
      <div class="description">
        <h1>「 ORIGINAL  」</h1>
        <p>1. Upload image</p>
        <p>2. Select a filter</p>
        <p>3. Adjust strength</p>
        <p>4. Move view!</p>
      </div>
      <img id="img1" src="images/img1.png" alt="Original"> </div>
  </div>
  <div class="filtered view" id="toggle1">
    <div class="content">
      <div class="description">
        <h1>「 FILTERED 」</h1>
        <p id="filterDynamic">"Gold Experience" filter applied</p>
      </div>
    </div>
  </div>
